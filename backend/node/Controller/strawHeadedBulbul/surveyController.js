...
{
  async getAllSurveys(databaseName = "StrawHeadedBulbul") 
  {
  ...
  async updateSurvey(recordId, updatedData, databaseName = "StrawHeadedBulbul") {
      const db = DatabaseConnectivity.getInstance();
      try {
  ...
  async insertSurvey(surveyData, databaseName = "StrawHeadedBulbul") {
    const db = DatabaseConnectivity.getInstance();
    try {
      await db.initialize();
      const collectionName = "Wildlife Survey";
  ...
  async deleteSurvey(recordId) {
    ...
    try {
      ...
      // Initialize database connection
      await db.initialize();
      const databaseName = "StrawHeadedBulbul";
      const collectionName = "Wildlife Survey";
