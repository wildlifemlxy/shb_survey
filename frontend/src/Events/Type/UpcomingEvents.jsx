...
class UpcomingEvents extends Component {
  ...
  handleAddNewEvent = () => {
    console.log('UpcomingEvents: handleAddNewEvent called - opening modal');
                          ...
                          <div style={{ display: 'flex', flexDirection: 'column', gap: 8, pointerEvents: 'auto', position: 'relative', zIndex: 10 }}>
                            ...
                            <div>
                              ...
                              {(() => {
                                const currentUser = JSON.parse(localStorage.getItem('user') || '{}');
                                const isWWFVolunteer = currentUser.role === 'WWF-Volunteer' || currentUser.Role === 'WWF-Volunteer';
                                const isWWFLedEvent = event.Organizer === 'WWF-led';
                                
                                // If it's a WWF-Volunteer editing a WWF-led event, show disabled field
                                if (isWWFVolunteer && isWWFLedEvent) {
                                  return (
                                    <input
                                      type="text"
                                      value={event.Organizer || 'WWF-led'}
                                      disabled
                                      style={{
                                        width: '100%',
                                        padding: '4px 8px',
                                  ...
                                  // For all other cases, show dropdown with options
                                  return (
                                    <select
