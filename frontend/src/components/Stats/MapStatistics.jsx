...
const MapStatistics = ({ data, validCoordinates }) => {
      ...
      <div className="map-stats-grid">
        ...
        <div className="map-stat-card">
          ...
          <div className="map-stat-content">
            ...
            <p>Observations with valid GPS coordinates</p>
            <div className="map-stat-breakdown">
              <span className="breakdown-item valid-coords">
                ✓ Mapped: {observationsWithCoordinates}
              </span>
              <span className="breakdown-item missing-coords">
