...
import '../../css/components/Charts/LocationStats.css';
        ...
        {locationData.map((entry, index) => {
          ...
          return (
            <div
              ...
              className={`statistics-entry ${isExpanded ? 'expanded' : ''}`}
            >
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
    ...
    const renderTabsNavigation = () => (
      <div className="insights-tabs">
        <button 
          ...
          className={`insights-tab ${this.state.activeTab1 === 'population' ? 'active' : ''}`}
        >
          Population Analysis
        </button>
        <button 
          onClick={() => this.setState({ activeTab1: 'anomalyTrends' })}
          className={`insights-tab ${this.state.activeTab1 === 'anomalyTrends' ? 'active' : ''}`}
        >
          Anomalies & Trends
        </button>
      </div>
  ...
  render() {
    ...
    return (
      <div className="location-stats">
        <div className="chart-header">
          <div className="chart-controls">
            ...
            {/*<button
              ...
              className={`chart-button ${showInsightsPanel ? 'active' : 'primary'}`}
            >
        ...
        {showInsightsPanel && this.renderInsightsPanel()}
